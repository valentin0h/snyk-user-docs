...
You can also import one cluster to multiple Snyk Organizations in manual import by [cloning an integration across your Snyk organizations](broken-reference), so the integrations have the same integration ID.
