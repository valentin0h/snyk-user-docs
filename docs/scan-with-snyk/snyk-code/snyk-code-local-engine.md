...
Snyk Code Local Engine is in [Early Access](broken-reference) and available only for Enterprise plans. If you are interested in using the feature, contact your Snyk account team.
{% endhint %}
