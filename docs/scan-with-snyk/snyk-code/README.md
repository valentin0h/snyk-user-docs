...
* [Snyk Web UI](broken-reference/) (including [PR checks](../run-pr-checks/))
* [Snyk IDE](../../integrate-with-snyk/use-snyk-in-your-ide/)
* [Snyk CLI](../../snyk-cli/)
* [Snyk API](broken-reference)
...
| **SaaS with a self-hosted Git server (requires Snyk Broker)**        | <p>For customers with SCMs that are not publicly accessible from the internet and want to connect Snyk Code with their local self-hosted SCM.<br><br>See <a href="broken-reference/">Snyk Broker - Code Agent</a>.</p>                                                                |
