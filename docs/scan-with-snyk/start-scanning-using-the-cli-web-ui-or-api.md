...
{% hint style="info" %}
Scans (tests) may be limited on your account, depending on your[ Pricing Plan](broken-reference/). For more information, see [What counts as a test?](../working-with-snyk/what-counts-as-a-test.md)
{% endhint %}
...
See [Explore Snyk through the Web UI](broken-reference).
