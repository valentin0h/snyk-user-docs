...
For details, see [Snyk Broker - Infrastructure as Code detection](broken-reference). For more information about Snyk Broker, see the [Broker](broken-reference) docs.
