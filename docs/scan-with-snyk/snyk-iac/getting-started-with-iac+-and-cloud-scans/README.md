...
{% hint style="warning" %}
IaC+ SCM integrations use the new Snyk [git repository cloning](broken-reference) capability to support multi-file analysis. This capability is available through [Snyk Preview](../../../snyk-admin/snyk-preview.md) and must be turned on for IaC+ SCM scans to work properly.
