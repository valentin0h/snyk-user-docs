...
A PR Check is counted as a test within your Organization's test count, including automatic checks of new commits in an open pull request. See[ What counts as a test](broken-reference). The number of tests allowed is determined by the [pricing plans](broken-reference/).
{% endhint %}
