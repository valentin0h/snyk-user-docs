...
* The fix strategy feature for getting dependency-oriented fixes is in [beta](broken-reference).
{% endhint %}
...
* One pull request is created per Project with a [priority score](broken-reference/) of **700 and above**.
