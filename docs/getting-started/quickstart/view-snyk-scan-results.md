...
This shows the number of issues found, grouped by severity level (**C**ritical, **H**igh, **M**edium or **L**ow). See [Severity levels](broken-reference) for more details.
...
Now, you can start to fix your issues. See [Manage risk](broken-reference).
