...
On the sidebar menu, select **Reports** to open reporting. For instructions on using the interface and interpreting the output, see [Reporting](broken-reference). For a demonstration, see the [Reporting video](https://learn.snyk.io/lesson/snyk-reports/) provided by Snyk Learn.
