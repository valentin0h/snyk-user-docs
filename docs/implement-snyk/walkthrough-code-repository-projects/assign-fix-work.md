...
For information about tracking the work, see the [Jira issues](https://learn.snyk.io/lesson/jira-issue/) video. For information about the overall management of issues, see [Manage risk](broken-reference) in the documentation.
