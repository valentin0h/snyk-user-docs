...
If you want to enable the Application Security Posture Management for all your used products, you can use the [Snyk AppRisk Implementation Guide](broken-reference).
...
* [Policies](broken-reference) that allow security and compliance teams to provide direction.
