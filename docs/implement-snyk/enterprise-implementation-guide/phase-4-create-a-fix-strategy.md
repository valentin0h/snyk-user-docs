...
{% hint style="info" %}
For more information on how to use reports, see [Introducing Snyk reports](broken-reference) and [Available Snyk Reports](broken-reference).
{% endhint %}
...
* When you filter by [Priority Score](broken-reference), CVSS Score is included in the calculation. One strategy is to eliminate the vulnerabilities with a score of 900-1000, and then move to vulnerabilities with a score of 800-900, and so on.
