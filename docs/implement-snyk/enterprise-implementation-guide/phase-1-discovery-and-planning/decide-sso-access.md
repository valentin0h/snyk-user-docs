...
For more information on SSO, see [Using Single Sign-On (SSO) for authentication](broken-reference)
...
For more information, see [Choose a Provisioning Option](broken-reference).
