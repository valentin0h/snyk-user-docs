...
If your SCM instance is not publicly accessible, you need Snyk Broker. You can install and configure your Snyk Broker using Docker or Helm. For more information about Snyk Broker, see the Snyk Broker documentation, including [Snyk Broker - AppRisk](broken-reference).
...
* GitHub - install and configure Snyk Broker
  * [using Docker](broken-reference)
  * [using Helm](broken-reference)
  * [environment variables](broken-reference)
