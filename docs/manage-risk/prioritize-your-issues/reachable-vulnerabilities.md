...
* [Brokered connections](broken-reference) (Currently in Early Access)
...
If you use a brokered connection to your SCM, configure the Broker to provide access to your source files. See the [Snyk Code - Clone capability with Broker for Docker](broken-reference), the [Broker rules for Snyk Code](broken-reference), and the [Snyk Broker - Code Agent](broken-reference) documentation for configuration details when the Broker is used with Snyk Code.
