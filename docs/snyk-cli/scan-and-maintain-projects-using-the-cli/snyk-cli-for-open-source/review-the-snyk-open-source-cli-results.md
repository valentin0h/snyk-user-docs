...
* The issue type
* The [severity rating](broken-reference) for the issue
...
License issues are determined by the [license policy](broken-reference) of your Snyk Organization. License issues contain the following information:
...
* **Local Snyk Policy:** Information about whether this scan was performed on an Open Source Project. For more information, see [The .snyk file](broken-reference).
