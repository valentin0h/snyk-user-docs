...
* **SSO**: See [Self-Serve Single Sign-On (SSO)](broken-reference/) for details.
* **Member Roles**: See [Manage Member Roles](../user-roles/user-role-management.md) for details.
* **Service Accounts**: See [Service accounts](broken-reference/) for details.
...
* **Languages**: Enable Reachable vulnerabilities analysis and edit language settings; see [Snyk Open Source - supported languages and package managers](broken-reference) for details.
