...
{% hint style="info" %}
Git repository cloning is in [Early Access](broken-reference) for GitHub, GitHub Enterprise, GitLab, Bitbucket Server, Bitbucket Cloud App, Bitbucket Cloud (Legacy), and Azure Repos integrations.
{% endhint %}
...
{% hint style="info" %}
For more information bout how Snyk performs Git repository cloning, applicable contract terms, and safeguards in place to keep your data safe, see the [Git repository cloning section](broken-reference) on the page "How Snyk handles your data."
{% endhint %}
