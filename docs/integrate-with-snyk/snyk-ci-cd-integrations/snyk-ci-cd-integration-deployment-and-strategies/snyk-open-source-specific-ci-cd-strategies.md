...
You can use a common [`.snyk` policy file](broken-reference) if you maintain ignores and patches in one place to be applied for all detected workspaces by providing the policy path as follows:
...
See [Java and Kotlin](../../../getting-started/supported-languages-and-frameworks/java-and-kotlin/) for more information.
