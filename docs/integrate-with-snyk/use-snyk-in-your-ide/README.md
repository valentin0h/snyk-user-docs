...
If Snyk is hosting your data in a region other than the default, you must set the `Custom endpoint` in the IDE. For more information, see [IDEs URLS](broken-reference) on the [Regional hosting and data residency](broken-reference) page.
